...
x q[7];
cx q[9],q[8];
u3(0.2942523647695424,0,0) q[8];
cx q[9],q[8];
u3(0.2942523647695425,-pi,-pi) q[8];
cx q[9],q[8];
u3(-0.0013469636205260128,0,0) q[8];
cx q[9],q[8];
u3(0.0013469636205260128,0,0) q[8];
ccx q[9],q[0],q[8];
cx q[9],q[8];
...
ccx q[9],q[0],q[8];
cx q[9],q[8];
u3(-0.0026939272410520256,0,0) q[8];
cx q[9],q[8];
u3(0.0026939272410520256,0,0) q[8];
x q[16];
ccx q[6],q[15],q[16];
...
ccx q[1],q[10],q[11];
cx q[9],q[8];
u3(-0.005387854482104051,0,0) q[8];
cx q[9],q[8];
u3(0.005387854482104051,0,0) q[8];
ccx q[9],q[2],q[8];
cx q[9],q[8];
...
ccx q[9],q[2],q[8];
cx q[9],q[8];
u3(-0.010775708964208102,0,0) q[8];
cx q[9],q[8];
u3(0.010775708964208102,0,0) q[8];
ccx q[9],q[3],q[8];
cx q[9],q[8];
...
ccx q[9],q[3],q[8];
cx q[9],q[8];
u3(-0.021551417928416205,0,0) q[8];
cx q[9],q[8];
u3(0.021551417928416205,0,0) q[8];
ccx q[9],q[4],q[8];
cx q[9],q[8];
...
x q[4];
cx q[9],q[8];
u3(-0.04310283585683241,0,0) q[8];
cx q[9],q[8];
u3(0.04310283585683241,0,0) q[8];
ccx q[9],q[5],q[8];
cx q[9],q[8];
...
ccx q[9],q[5],q[8];
cx q[9],q[8];
u3(-0.08620567171366482,0,0) q[8];
cx q[9],q[8];
u3(0.08620567171366482,0,0) q[8];
ccx q[9],q[6],q[8];
cx q[9],q[8];
...
ccx q[9],q[6],q[8];
cx q[9],q[8];
u3(-0.17241134342732964,0,0) q[8];
cx q[9],q[8];
u3(0.17241134342732964,0,0) q[8];
ccx q[9],q[7],q[8];
cx q[9],q[8];
